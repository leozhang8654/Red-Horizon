...
const TEX_FULL := preload("res://ui/art/shield_full.png")    # 有血（亮青）
const TEX_EMPTY := preload("res://ui/art/shield_empty.png")  # 掉了（暗壳）
const TEX_WARN := preload("res://ui/art/shield_warn.png")    # 警告（红，叠在亮青上闪）
