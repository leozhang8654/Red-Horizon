...
var _bullet_scene := preload("res://Mantis-Lux母舰/mantis_lux_bullet.tscn")   # Boss 核心子弹（环形弹幕）
var _turret_bullet_scene := preload("res://Mantis-Lux母舰/mantis_lux_turret_bullet.tscn")   # 炮台机枪子弹
var _barrel_explosion_scene := preload("res://Mantis-Lux母舰/barrel_explosion.tscn")   # 炮台专用爆炸
var _death_anim_scene := preload("res://Mantis-Lux母舰/mantis_lux_death_anim.tscn")   # 死亡演出(5秒爆炸解体动画)
